...
Procedure InformarCategoria(i:integer);
Begin
  Writeln();
  Writeln('La categoria seleccionada es : ');
  Case i Of 
    1: Write('Conceptos de organizacion');
    2: Write('Algoritmos y estructuras de control');
    3: Write('Tipos y estructuras de datos');
    4: Write('Alocacion dinamica y estatica');
    5: Write('Eficiencia y correcion');
  End;
End;
...
Var Jugador1,Jugador2,Palabra,aux: string; {Nombres de cada jugador}
  Errores,JugadorActual: integer; {Identificador del jug act en integer}
...
'El juego consiste en adivinar palabras relacionadas con conceptos de Programacion 1, para eso las palabras estaran divididas en 5 categorias: '
  ...
  Writeln(
          ...
          'Se seleccionara una categoria al azar y luego una palabra la cual el jugador de turno tendra que adivinar..'
  )
  ;
  Writeln(

          'El juego termina cuando uno de los jugadores suma 10 o mas puntos , o bien uno de los dos jugadores pierda.'
  )
  ;
  Writeln(
